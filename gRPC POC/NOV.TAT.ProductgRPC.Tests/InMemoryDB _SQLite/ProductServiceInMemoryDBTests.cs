...
{
    [TestClass]
    public class ProductServiceInMemoryDBTests : ProductServiceInMemoryDBBase
    {
        private ProductService productservice;
        private IMapper mapper;
        private ILogger<ProductService> logger;
        private ServerCallContext serverCallContext;
        public ProductServiceInMemoryDBTests() : base()
        {
        ...
        {          
            using (context = CreateContextForInMemory())
            {
